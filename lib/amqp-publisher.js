...
class AMQPPublisher extends AMQP {
     ...
     */
    constructor({ serviceName, host, username, password, retry, exchange, route, durable = false, type = 'topic' }) {
        super({ serviceName, host, username, password, retry, exchange, route, durable, type, logger });
    }
