...
class AMQPPublisher extends AMQP {
     ...
     */
    constructor({ serviceName, host, username, password, logger, retry, exchange, route, durable = false, type = 'topic' }) {
        super({ serviceName, host, username, password, logger, retry, exchange, route, durable, type, logger });
    }
