...
*                                         that can be awaiting acknowledgement
     */
    constructor({ host, username, password, logger, retry, durable = false, noAck = true, deadLetterExchange, prefetch = 0 }) {
        super();
        const loggerChild = logger.child({ host, username });
        Object.assign(this,
            { host, username, password, loggerChild, retry, durable, noAck, deadLetterExchange, prefetch });
    }
